...
void nb_iot_task(void *argument)
{
	...
	void ac_network_attach_request(recived_msgs_ac);
	void ac_network_pdp_activate (recived_msgs_ac);
	void ac_nb_iot_send	(ready_buffer,sizeof(package_data_t),recived_msgs_ac);
